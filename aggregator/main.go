...
func main() {
	httpListenAddr := flag.String("httpListenAddr", ":4000", "the listening address of the HTTP Server")
	grpcListenAddr := flag.String("grpcListenAddr", ":4001", "the listening address of the GRPC Server")
	flag.Parse()
